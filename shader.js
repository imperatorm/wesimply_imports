...
see: http://github.com/greggman/twgl.js for details */ let ot = Float32Array;
function H(e, t, i) {
  const n = new ot(3);
...
function Lt(e, t, i) {
  i = i || new ot(3);
  const n = e[2] * t[0] - e[0] * t[2],
    r = e[0] * t[1] - e[1] * t[0];
  return (i[0] = e[1] * t[2] - e[2] * t[1]), (i[1] = n), (i[2] = r), i;
}
function pt(e, t) {
  t = t || new ot(3);
  const i = e[0] * e[0] + e[1] * e[1] + e[2] * e[2],
    n = Math.sqrt(i);
  return (
    n > 1e-5
...
function Xt(e, t) {
  ...
  const i = e[0 * 4 + 0],
    ...
    it = i * a,
    nt = s * n,
    Rt = d * a + w * u + C * A - (_ * a + E * u + z * A),
    Pt = _ * n + I * u + R * A - (d * n + $ * u + B * A),
    Mt = E * n + $ * a + P * A - (w * n + I * a + M * A),
    Dt = z * n + B * a + M * u - (C * n + R * a + P * u),
    T = 1 / (i * Rt + s * Pt + h * Mt + m * Dt);
  return (
    (t[0] = T * Rt),
    (t[1] = T * Pt),
    (t[2] = T * Mt),
    (t[3] = T * Dt),
    (t[4] = T * (_ * s + E * h + z * m - (d * s + w * h + C * m))),
    (t[5] = T * (d * i + $ * h + B * m - (_ * i + I * h + R * m))),
    (t[6] = T * (w * i + I * s + M * m - (E * i + $ * s + P * m))),
    (t[7] = T * (C * i + R * s + P * h - (z * i + B * s + M * h))),
    (t[8] = T * (D * c + U * g + N * p - (L * c + k * g + q * p))),
    (t[9] = T * (L * o + J * g + et * p - (D * o + Z * g + tt * p))),
    (t[10] = T * (k * o + Z * c + it * p - (U * o + J * c + nt * p))),
    (t[11] = T * (q * o + tt * c + nt * g - (N * o + et * c + it * g))),
    (t[12] = T * (k * f + q * y + L * l - (N * y + D * l + U * f))),
    (t[13] = T * (tt * y + D * r + Z * f - (J * f + et * y + L * r))),
    (t[14] = T * (J * l + nt * y + U * r - (it * y + k * r + Z * l))),
    (t[15] = T * (it * f + N * r + et * l - (tt * l + nt * f + q * r))),
    t
  );
}
function Ne(e, t, i) {
  ...
  return (
    ...
    (i[8] = n * R + a * P + u * M + A * D),
    (i[9] = r * R + l * P + f * M + y * D),
    (i[10] = o * R + c * P + g * M + p * D),
    (i[11] = s * R + h * P + m * M + d * D),
    (i[12] = n * L + a * k + u * U + A * N),
    (i[13] = r * L + l * k + f * U + y * N),
    (i[14] = o * L + c * k + g * U + p * N),
    (i[15] = s * L + h * k + m * U + d * N),
    i
  );
}
function Oe(e, t, i) {
...
function Ye(e, t, i, n, r) {
  r = r || new x(16);
  const o = Math.tan(Math.PI * 0.5 - 0.5 * e),
    s = 1 / (i - n);
  return (
    (r[0] = o / t),
    (r[1] = 0),
...
function si(e, t, i) {
  ...
  return (
    ...
    (i[11] = o * e[2 * 4 + 3]),
    e !== i &&
      ((i[12] = e[12]), (i[13] = e[13]), (i[14] = e[14]), (i[15] = e[15])),
    i
  );
}
function ai(e, t, i) {
  ...
  const n = t[0],
    r = t[1],
    o = t[2],
    s = n * e[0 * 4 + 3] + r * e[1 * 4 + 3] + o * e[2 * 4 + 3] + e[3 * 4 + 3];
  return (
    (i[0] =
      (n * e[0 * 4 + 0] + r * e[1 * 4 + 0] + o * e[2 * 4 + 0] + e[3 * 4 + 0]) /
      s),
    (i[1] =
      (n * e[0 * 4 + 1] + r * e[1 * 4 + 1] + o * e[2 * 4 + 1] + e[3 * 4 + 1]) /
      s),
    (i[2] =
      (n * e[0 * 4 + 2] + r * e[1 * 4 + 2] + o * e[2 * 4 + 2] + e[3 * 4 + 2]) /
      s),
    i
  );
}
function ci(e, t, i) {
  ...
  const n = t[0],
    ...
    o = t[2];
  return (
    (i[0] = n * e[0 * 4 + 0] + r * e[1 * 4 + 0] + o * e[2 * 4 + 0]),
    (i[1] = n * e[0 * 4 + 1] + r * e[1 * 4 + 1] + o * e[2 * 4 + 1]),
    (i[2] = n * e[0 * 4 + 2] + r * e[1 * 4 + 2] + o * e[2 * 4 + 2]),
    i
  );
}
function li(e, t, i) {
  ...
  const n = Xt(e),
    ...
    s = t[2];
  return (
    (i[0] = r * n[0 * 4 + 0] + o * n[0 * 4 + 1] + s * n[0 * 4 + 2]),
    (i[1] = r * n[1 * 4 + 0] + o * n[1 * 4 + 1] + s * n[1 * 4 + 2]),
    (i[2] = r * n[2 * 4 + 0] + o * n[2 * 4 + 1] + s * n[2 * 4 + 2]),
    i
  );
}
...
function jt(e) {
  if (e instanceof Int8Array) return At;
  if (e instanceof Uint8Array || e instanceof Uint8ClampedArray) return K;
  if (e instanceof Int16Array) return yt;
  if (e instanceof Uint16Array) return _t;
  if (e instanceof Int32Array) return xt;
  if (e instanceof Uint32Array) return bt;
  if (e instanceof Float32Array) return Et;
  throw new Error("unsupported typed array type");
}
function Kt(e) {
  if (e === Int8Array) return At;
  if (e === Uint8Array || e === Uint8ClampedArray) return K;
  if (e === Int16Array) return yt;
  if (e === Uint16Array) return _t;
  if (e === Int32Array) return xt;
  if (e === Uint32Array) return bt;
  if (e === Float32Array) return Et;
  throw new Error("unsupported typed array type");
}
function yi(e) {
  const t = Wt[e];
...
function Ii(e, t, i, n, r) {
  e.bindBuffer(t, i), e.bufferData(t, n, r || Jt);
}
function ee(e, t, i, n) {
  if (xi(e, t)) return t;
  i = i || W;
  const r = e.createBuffer();
  return Ii(e, i, r, t, n), r;
}
function ie(e) {
  return e === "indices";
}
...
const Ri = /coord|texture/i,
  Pi = /color|colour/i;
function Mi(e, t) {
  let i;
  if ((Ri.test(e) ? (i = 2) : Pi.test(e) ? (i = 4) : (i = 3), t % i > 0))
    throw new Error(
      `Can not guess numComponents for attribute '${e}'. Tried ${i} but ${t} values is not evenly divisible by ${i}. You should specify it.`
    );
  return i;
}
function Di(e, t, i) {
  return e.numComponents || e.size || Mi(t, i || Bi(e).length);
}
function ne(e, t) {
  if (mt(e)) return e;
  if (mt(e.data)) return e.data;
  Array.isArray(e) && (e = {data: e});
  let i = e.type ? wt(e.type) : void 0;
  return i || (ie(t) ? (i = Uint16Array) : (i = Float32Array)), new i(e.data);
}
function Li(e) {
  return typeof e == "number" ? e : e ? Kt(e) : Zt;
}
function wt(e) {
  return typeof e == "number" ? yi(e) : e || Float32Array;
}
function ki(e, t) {
  return {
    buffer: t.buffer,
...
function Ui(e, t) {
  const i = t.data || t,
    n = wt(t.type),
    r = i * n.BYTES_PER_ELEMENT,
    o = e.createBuffer();
  return (
    e.bindBuffer(W, o),
    e.bufferData(W, r, t.drawType || Jt),
    {buffer: o, numValues: i, type: Kt(n), arrayType: n}
  );
}
function Ni(e, t, i) {
  const n = ne(t, i);
  return {
    ...
    buffer: ee(e, n, void 0, t.drawType),
    type: jt(n),
    numValues: 0,
  };
}
function Oi(e, t) {
  ...
  return (
    Object.keys(t).forEach(function (n) {
      if (!ie(n)) {
        const r = t[n],
          o = r.attrib || r.name || r.attribName || te.attribPrefix + n;
        if (r.value) {
          ...
          r.buffer && r.buffer instanceof WebGLBuffer
            ...
            ? (s = Ui)
            : (s = Ni);
          const {buffer: a, type: l, numValues: c, arrayType: h} = s(e, r, n),
            u = r.normalize !== void 0 ? r.normalize : $i(h),
            f = Di(r, n, c);
          i[o] = {
            buffer: a,
            numComponents: f,
...
const dt = ["position", "positions", "a_position"];
function Gi(e, t) {
  let i, n;
  for (
    n = 0;
    n < dt.length &&
    ((i = dt[n]), !(i in t || ((i = te.attribPrefix + i), i in t)));
    ++n
  );
  n === dt.length && (i = Object.keys(t)[0]);
  const r = t[i];
  if (!r.buffer) return 1;
  e.bindBuffer(W, r.buffer);
  const o = e.getBufferParameter(W, Ei);
  e.bindBuffer(W, null);
  const s = Vi(e, r.type),
    a = o / s,
...
function re(e, t, i) {
  ...
  const o = t.indices;
  if (o) {
    const s = ne(o, "indices");
    (r.indices = ee(e, s, bi)),
      (r.numElements = s.length),
      (r.elementType = jt(s));
  } else r.numElements || (r.numElements = Gi(e, r.attribs));
  return r;
}
function Tt(e) {
...
function S(e, t, i, n) {
  ...
  return Tt(e)
    ? function (o) {
        ...
        !o || qt(e, o)
          ? ((s = o), (a = null))
          : ((s = o.texture), (a = o.sampler)),
          e.uniform1i(n, i),
          e.activeTexture(rt + i),
          e.bindTexture(r, s),
          e.bindSampler(i, a);
      }
    : function (o) {
...
function F(e, t, i, n, r) {
  const o = Ee(e, t),
    s = new Int32Array(r);
  for (let a = 0; a < r; ++a) s[a] = i + a;
  return Tt(e)
    ? function (a) {
        e.uniform1iv(n, s),
          a.forEach(function (l, c) {
            e.activeTexture(rt + s[c]);
            let h, u;
            !l || qt(e, l)
              ? ((h = l), (u = null))
              : ((h = l.texture), (u = l.sampler)),
              e.bindSampler(i, u),
              e.bindTexture(o, h);
          });
      }
    : function (a) {
        e.uniform1iv(n, s),
          a.forEach(function (l, c) {
            e.activeTexture(rt + s[c]), e.bindTexture(o, l);
          });
      };
}
v[at] = {Type: Float32Array, size: 4, setter: Sn, arraySetter: Fn};
v[ae] = {Type: Float32Array, size: 8, setter: Cn, cols: 2};
v[ce] = {Type: Float32Array, size: 12, setter: zn, cols: 3};
v[le] = {Type: Float32Array, size: 16, setter: In, cols: 4};
v[Ft] = {Type: Int32Array, size: 4, setter: we, arraySetter: Te};
v[ue] = {Type: Int32Array, size: 8, setter: Se, cols: 2};
v[he] = {Type: Int32Array, size: 12, setter: Fe, cols: 3};
v[fe] = {Type: Int32Array, size: 16, setter: Ce, cols: 4};
v[Ct] = {Type: Uint32Array, size: 4, setter: $n, arraySetter: Bn};
v[_e] = {Type: Uint32Array, size: 8, setter: Rn, cols: 2};
v[xe] = {Type: Uint32Array, size: 12, setter: Pn, cols: 3};
v[be] = {Type: Uint32Array, size: 16, setter: Mn, cols: 4};
v[pe] = {Type: Uint32Array, size: 4, setter: we, arraySetter: Te};
v[de] = {Type: Uint32Array, size: 8, setter: Se, cols: 2};
v[ge] = {Type: Uint32Array, size: 12, setter: Fe, cols: 3};
v[me] = {Type: Uint32Array, size: 16, setter: Ce, cols: 4};
v[ve] = {Type: Float32Array, size: 32, setter: Dn, rows: 2, cols: 2};
v[Ae] = {Type: Float32Array, size: 48, setter: Ln, rows: 3, cols: 3};
v[ye] = {Type: Float32Array, size: 64, setter: kn, rows: 4, cols: 4};
v[ln] = {Type: Float32Array, size: 32, setter: Un, rows: 2, cols: 3};
v[un] = {Type: Float32Array, size: 32, setter: On, rows: 2, cols: 4};
v[hn] = {Type: Float32Array, size: 48, setter: Nn, rows: 3, cols: 2};
v[fn] = {Type: Float32Array, size: 48, setter: Gn, rows: 3, cols: 4};
v[pn] = {Type: Float32Array, size: 64, setter: Vn, rows: 4, cols: 2};
v[dn] = {Type: Float32Array, size: 64, setter: Hn, rows: 4, cols: 3};
v[on] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ct};
v[sn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: lt};
v[an] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: zt};
v[cn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ct};
v[gn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ut};
v[mn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ut};
v[vn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: lt};
v[An] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ct};
v[yn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: zt};
v[_n] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: lt};
v[xn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ut};
v[bn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ct};
v[En] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: zt};
v[wn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: lt};
v[Tn] = {Type: null, size: 0, setter: S, arraySetter: F, bindPoint: ut};
function ht(e, t) {
  return function (i) {
    if (i.value)
...
function It(e, t, i) {
  ...
  return function (o) {
    ...
    const s = o.size || o.numComponents || n,
      a = s / r,
      l = o.type || at,
      h = v[l].size * s,
      u = o.normalize || !1,
      ...
      g = h / r;
    for (let m = 0; m < r; ++m)
      e.enableVertexAttribArray(t + m),
        e.vertexAttribPointer(t + m, a, l, u, h, f + g * m),
        e.vertexAttribDivisor && e.vertexAttribDivisor(t + m, o.divisor || 0);
  };
}
const b = {};
b[at] = {size: 4, setter: ht};
b[ae] = {size: 8, setter: ht};
b[ce] = {size: 12, setter: ht};
b[le] = {size: 16, setter: ht};
b[Ft] = {size: 4, setter: Y};
b[ue] = {size: 8, setter: Y};
b[he] = {size: 12, setter: Y};
b[fe] = {size: 16, setter: Y};
b[Ct] = {size: 4, setter: ft};
b[_e] = {size: 8, setter: ft};
b[xe] = {size: 12, setter: ft};
b[be] = {size: 16, setter: ft};
b[pe] = {size: 4, setter: Y};
b[de] = {size: 8, setter: Y};
b[ge] = {size: 12, setter: Y};
b[me] = {size: 16, setter: Y};
b[ve] = {size: 4, setter: It, count: 2};
b[Ae] = {size: 9, setter: It, count: 3};
b[ye] = {size: 16, setter: It, count: 4};
const Yn = /ERROR:\s*\d+:(\d+)/gi;
function Xn(e, t = "", i = 0) {
  const n = [...t.matchAll(Yn)],
    r = new Map(
      n.map((o, s) => {
        const a = parseInt(o[1]),
          l = n[s + 1],
          c = l ? l.index : t.length,
          h = t.substring(o.index, c);
        return [a - 1, h];
      })
    );
  return e
...
function ze(e) {
  let t = 0;
  return (
    Nt.test(e) && ((t = 1), (e = e.replace(Nt, ""))),
    {lineOffset: t, shaderSource: e}
  );
}
function Wn(e, t) {
  return (
...
function jn(e, t, i, n) {
  if (((n = n || St), !e.getShaderParameter(i, Xi))) {
    const o = e.getShaderInfoLog(i),
      {lineOffset: s, shaderSource: a} = ze(e.getShaderSource(i)),
      l = `${Xn(a, o, s)}
Error compiling ${Hi(e, t)}: ${o}`;
    return n(l), l;
  }
  return "";
}
function $t(e, t, i) {
  let n, r, o;
  if (
    (typeof t == "function" && ((i = t), (t = void 0)), typeof e == "function")
  )
    (i = e), (e = void 0);
    ...
    (i = c.errorCallback),
      (e = c.attribLocations),
      (n = c.transformFeedbackVaryings),
      (r = c.transformFeedbackMode),
      (o = c.callback);
  }
  const s = i || St,
    a = [],
...
const Kn = ["VERTEX_SHADER", "FRAGMENT_SHADER"];
function Qn(e, t) {
  if (t.indexOf("frag") >= 0) return ji;
  if (t.indexOf("vert") >= 0) return Ki;
}
function qn(e, t, i) {
  const n = e.getAttachedShaders(t);
  for (const r of n) i.has(r) && e.deleteShader(r);
  e.deleteProgram(t);
}
const Jn = (e = 0) => new Promise((t) => setTimeout(t, e));
function Zn(e, t, i) {
  ...
  for (let a = 0; a < t.length; ++a) {
    ...
    if (typeof l == "string") {
      const c = oe(l),
        h = c ? c.text : l;
      let u = e[Kn[a]];
      c && c.type && (u = Qn(e, c.type) || u),
        (l = e.createShader(u)),
        e.shaderSource(l, ze(h).shaderSource),
        e.compileShader(l),
        e.attachShader(n, l);
    }
  }
  Object.entries(r).forEach(([a, l]) => e.bindAttribLocation(n, l, a));
  {
    let a = o;
    a &&
      (a.attribs && (a = a.attribs),
      Array.isArray(a) || (a = Object.keys(a)),
      e.transformFeedbackVaryings(n, a, s || Qi));
  }
...
function tr(e, t, i, n, r) {
  const o = $t(i, n, r),
    ...
    a = Zn(e, t, o);
  function l(c, h) {
    const u = ir(c, h, o.errorCallback);
    return u && qn(c, h, s), u;
  }
  if (o.callback) {
    er(e, a).then(() => {
      const c = l(e, a);
      o.callback(c, c ? void 0 : a);
    });
    return;
  }
  return l(e, a) ? void 0 : a;
}
async function er(e, t) {
  const i = e.getExtension("KHR_parallel_shader_compile"),
    n = i
      ? (o, s) => o.getProgramParameter(s, i.COMPLETION_STATUS_KHR)
      : () => !0;
  let r = 0;
  do await Jn(r), (r = 1e3 / 60);
  while (!n(e, t));
}
function ir(e, t, i) {
  if (((i = i || St), !e.getProgramParameter(t, Wi))) {
    const r = e.getProgramInfoLog(t);
    i(`Error in program linking: ${r}`);
    const s = e
      .getAttachedShaders(t)
      .map((a) => jn(e, e.getShaderParameter(a, e.SHADER_TYPE), a, i));
    return `${r}
${s.filter((a) => a).join(`
`)}`;
  }
...
function ar(e, t) {
  let i = 0;
  function n(a, l, c) {
    const h = l.name.endsWith("[0]"),
      u = l.type,
      f = v[u];
    if (!f) throw new Error(`unknown type: 0x${u.toString(16)}`);
    let g;
    if (f.bindPoint) {
      const m = i;
      (i += l.size),
        h
          ? (g = f.arraySetter(e, u, m, c, l.size))
          : (g = f.setter(e, u, m, c, l.size));
    } else
      f.arraySetter && h ? (g = f.arraySetter(e, c)) : (g = f.setter(e, c));
    return (g.location = c), g;
  }
  const r = {},
    o = {},
    s = e.getProgramParameter(t, se);
  for (let a = 0; a < s; ++a) {
    const l = e.getActiveUniform(t, a);
    if (Ie(l)) continue;
    let c = l.name;
    c.endsWith("[0]") && (c = c.substr(0, c.length - 3));
    const h = e.getUniformLocation(t, l.name);
    if (h) {
      const u = n(t, l, h);
      (r[c] = u), sr(c, u, o, r);
    }
...
function cr(e, t) {
  const i = {},
    n = e.getProgramParameter(t, Ji);
  for (let r = 0; r < n; ++r) {
    const o = e.getTransformFeedbackVarying(t, r);
    i[o.name] = {index: r, type: o.type, size: o.size};
  }
  return i;
}
function lr(e, t) {
  const i = e.getProgramParameter(t, se),
    n = [],
    r = [];
  for (let a = 0; a < i; ++a) {
    r.push(a), n.push({});
  ...
  [
    ...
    const l = a[0],
      c = a[1];
    e.getActiveUniforms(t, r, e[l]).forEach(function (h, u) {
      n[u][c] = h;
    });
  });
  const o = {},
    s = e.getProgramParameter(t, Zi);
  for (let a = 0; a < s; ++a) {
    const l = e.getActiveUniformBlockName(t, a),
      c = {
        index: e.getUniformBlockIndex(t, l),
        usedByVertexShader: e.getActiveUniformBlockParameter(t, a, tn),
        usedByFragmentShader: e.getActiveUniformBlockParameter(t, a, en),
        size: e.getActiveUniformBlockParameter(t, a, nn),
        uniformIndices: e.getActiveUniformBlockParameter(t, a, rn),
      };
    (c.used = c.usedByVertexShader || c.usedByFragmentShader), (o[l] = c);
  }
...
function $e(e, t) {
  for (const i in t) {
    const n = e[i];
    typeof n == "function" ? n(t[i]) : $e(e[i], t[i]);
  }
}
function j(e, ...t) {
  const i = e.uniformSetters || e,
    n = t.length;
  for (let r = 0; r < n; ++r) {
    const o = t[r];
    if (Array.isArray(o)) {
      const s = o.length;
      for (let a = 0; a < s; ++a) j(i, o[a]);
    } else
      for (const s in o) {
        const a = i[s];
        a && a(o[s]);
...
function ur(e, t) {
  const i = {},
    n = e.getProgramParameter(t, qi);
  for (let r = 0; r < n; ++r) {
    const o = e.getActiveAttrib(t, r);
    if (Ie(o)) continue;
    const s = e.getAttribLocation(t, o.name),
      a = b[o.type],
      l = a.setter(e, s, a);
    (l.location = s), (i[o.name] = l);
  }
  return i;
}
function hr(e, t) {
...
function Be(e, t, i) {
  i.vertexArrayObject
    ? e.bindVertexArray(i.vertexArrayObject)
    : (hr(t.attribSetters || t, i.attribs),
      i.indices && e.bindBuffer(Yi, i.indices));
}
function Ot(e, t) {
  const i = ar(e, t),
    n = ur(e, t),
    r = {program: t, uniformSetters: i, attribSetters: n};
  return (
    Tt(e) &&
      ((r.uniformBlockSpec = lr(e, t)), (r.transformFeedbackInfo = cr(e, t))),
    r
  );
}
const fr = /\s|{|}|;/;
...
function Pe(e, t, i, n, r, o) {
  ...
  const s = t.indices,
    a = t.elementType,
    l = n === void 0 ? t.numElements : n;
  (r = r === void 0 ? 0 : r),
    a || s
      ? o !== void 0
        ? e.drawElementsInstanced(i, l, a === void 0 ? Vt : t.elementType, r, o)
        : e.drawElements(i, l, a === void 0 ? Vt : t.elementType, r)
      : o !== void 0
      ? e.drawArraysInstanced(i, r, l, o)
      : e.drawArrays(i, r, l);
}
function dr(e, t) {
  (t = t || 1), (t = Math.max(0, t));
  const i = (e.clientWidth * t) | 0,
    n = (e.clientHeight * t) | 0;
  return e.width !== i || e.height !== n
    ? ((e.width = i), (e.height = n), !0)
    : !1;
}
class gr {
  constructor(t) {
    (this.gl = t),
      ...
      (document.onscroll = (i) => this.onScroll(i));
  }
  onScroll(t) {
...
class mr {
  constructor(t, i = {z: -9, fov: 0.6, near: 1, far: 1024}) {
    (i.fov = vr(35)), (this.camera = i);
  }
  get(t) {
    return (
      (this.camera.mat = kt.translate(
        kt.perspective(
          this.camera.fov,
 ...
 */ class O {
  constructor(t, i, n, r, o = "div") {
    (this.parent = t),
      ...
      (O.nextNameID = O.nextNameID || 0),
      (this.$name.id = `lil-gui-name-${++O.nextNameID}`),
      (this.$widget = document.createElement(o)),
...
class wr extends O {
  constructor(t, i, n, r) {
    super(t, i, n, "color"),
      ...
      (this._format = Er(this.initialValue)),
      (this._rgbScale = r),
...
class Tr extends O {
  ...
  _initInput() {
    ...
    const t = () => {
      ...
      i = (p) => {
        ...
        isNaN(d) ||
          (this._snapClampSetValue(d + p),
          (this.$input.value = this.getValue()));
      },
      n = (p) => {
        p.code === "Enter" && this.$input.blur(),
          p.code === "ArrowUp" &&
            (p.preventDefault(), i(this._step * this._arrowKeyMultiplier(p))),
          p.code === "ArrowDown" &&
            (p.preventDefault(),
            i(this._step * this._arrowKeyMultiplier(p) * -1));
      },
      r = (p) => {
        this._inputFocused &&
          (p.preventDefault(), i(this._step * this._normalizeMouseWheel(p)));
      };
    let o = !1,
      s,
      a,
    ...
    const u = 5,
      ...
      g = (p) => {
        ...
        if (!o) {
          const d = p.clientY - l;
          (h -= d * this._step * this._arrowKeyMultiplier(p)),
            c + h > this._max
              ? (h = this._max - c)
  ...
  _initSlider() {
    ...
    const t = (p, d, _, E, w) => ((p - d) / (_ - d)) * (w - E) + E,
      i = (p) => {
        const d = this.$slider.getBoundingClientRect();
        let _ = t(p, d.left, d.right, this._min, this._max);
    ...
    const c = (p) => {
      ...
      h = (p) => {
        p.touches.length > 1 ||
          (this._hasScrollBar
            ? ((a = p.touches[0].clientX), (l = p.touches[0].clientY), (s = !0))
            : c(p),
...
class Sr extends O {
  ...
  updateDisplay() {
    ...
    return (
      ...
      (this.$display.innerHTML = i === -1 ? t : this._names[i]),
      this
    );
  }
}
...
class Bt {
  ...
  add(t, i, n, r, o) {
    if (Object(n) === n) return new Sr(this, t, i, n);
    const s = t[i];
    switch (typeof s) {
      case "number":
        return new Tr(this, t, i, n, r, o);
      case "boolean":
        return new Ar(this, t, i);
      case "string":
        return new Fr(this, t, i);
      case "function":
  ...
  reset(t = !0) {
    return (
      (t ? this.controllersRecursive() : this.controllers).forEach((n) =>
        n.reset()
      ),
      this
    );
...
class Pr {
  constructor(t, i = {}) {
    (this.gl = t),
      (this.data = i),
      (this.shaders = Rr),
      (this.programInfo = Re(this.gl, this.shaders)),
  ...
  setUniforms() {
    (this.uniforms = {
      ...
      this.gl.useProgram(this.programInfo.program),
      j(this.programInfo, this.uniforms);
  }
  render(t, {x: i, y: n}) {
    this.gl.useProgram(this.programInfo.program),
      Be(this.gl, this.programInfo, this.bufferInfo),
      j(this.programInfo, {
        u_time: t * this.data.time,
        u_mouse: [i, n],
        u_mode: this.a.mode,
      }),
      Pe(this.gl, this.bufferInfo);
  }
  resize(t) {
    (this.gl = t),
      this.gl.useProgram(this.programInfo.program),
...
class Mr {
  ...
  create() {
    this.quad = new Pr(this.gl, this.params);
  }
  render(t, i) {
...
var Dr = `attribute vec4 position;
...
class Ur {
  ...
  render(t, i = null) {
    this.gl.useProgram(this.programInfo.program),
      Be(this.gl, this.programInfo, this.bufferInfo),
      j(this.programInfo, {u_time: t, u_diff: i}),
      Pe(this.gl, this.bufferInfo);
  }
  resize(t) {
    (this.gl = t),
...
class Or {
  ...
  create() {
    (this.post = new Nr(this.gl)),
      (this.post.isActive = !1),
      (this.scene = new Mr(this.gl)),
  ...
  resize() {
    dr(this.gl.canvas, this.gl.vp.dpr),
      (this.gl.vp = {
